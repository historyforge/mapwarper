class LayersController < ApplicationController
  ...
  before_action :authenticate_user! , :except => [:wms, :wms2, :show_kml, :show, :index, :metadata, :maps, :thumb, :geosearch, :comments, :tile, :trace, :id]
  before_action :check_administrator_role, :only => [:publish, :toggle_visibility, :merge, :trace, :id] 
  
  before_action :find_layer, :only => [:show, :export, :metadata, :toggle_visibility, :update_year, :publish, :remove_map, :merge, :maps, :thumb, :comments, :trace, :id]
